...
argfilter.addArg('plugnick',
                 '插件昵称',
                 '需要输入插件的昵称',
                 prefunc=(lambda arg: (arg
                                       if arg in plugGetNameList() else None)),
                 canSkip=True,
                 vlimit={'': ''})
argfilter.addArg(
    'page',
...
@on_message(msgfilter='全局禁用插件',
            argfilter=argfilter,
            bindsendperm='manage',
            des='全局禁用插件 插件名 - 全局禁用插件')
async def _(session: Session):
    plugnick = session.filterargs['plugnick']
...
@on_message(msgfilter='全局启用插件',
            argfilter=argfilter,
            bindsendperm='manage',
            des='全局启用插件 插件名 - 全局启用插件')
async def _(session: Session):
    plugnick = session.filterargs['plugnick']
    plug: PluginsManage = plugGetNamePlug(plugnick)
    if plug:
...
@on_message(msgfilter='禁用插件',
            argfilter=argfilter,
            sourceAdmin=True,
            des='禁用插件 插件名 - 在当前聊天中禁用插件')
async def _(session: Session):
    plugnick = session.filterargs['plugnick']
    plug: PluginsManage = plugGetNamePlug(plugnick)
    if plug:
...
@on_message(msgfilter='启用插件',
            argfilter=argfilter,
            sourceAdmin=True,
            des='启用插件 插件名 - 在当前聊天中启用插件')
async def _(session: Session):
    plugnick = session.filterargs['plugnick']
    plug: PluginsManage = plugGetNamePlug(plugnick)
    if plug:
