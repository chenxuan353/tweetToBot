...
google = {
    ...
    "谷歌",
    "switch":
    MachineTransApi['google']['switch'],
    'bucket':
    TokenBucket(5, 5),
    'url':
    "http://translate.google.cn/translate_a/single?client=at&dt=t&dj=1&ie=UTF-8&sl={Source}&tl={Target}&q={SourceText}"
}
...
def google_MachineTrans(SourceText, Source='auto', Target='zh'):
    ...
    try:
        requrl = google['url'].format(SourceText=SourceText,
                                      Source=Source,
                                      Target=Target)
